...
async def get_unified_profile(user_session: str, profile_service: ProfileService = Depends(get_profile_service)):
...
async def get_user_stats(user_session: str, profile_service: ProfileService = Depends(get_profile_service)):
...
async def delete_user_data(user_session: str, profile_service: ProfileService = Depends(get_profile_service)):
...
async def export_user_data(user_session: str, profile_service: ProfileService = Depends(get_profile_service)):
